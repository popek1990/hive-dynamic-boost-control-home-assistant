...
MESSAGES = {
    "en": {
        ...
        "sensor_unavailable_header": "⚠️ The Hive sensor reports no data",
        "sensor_unchanged_header": "⚠️ The temperature reading has not moved",
        "sensor_stale_unavailable": "The sensor says 'unavailable'.",
        "sensor_stale_age": "Unchanged for {age}, still reading {temperature} °C.",
        "sensor_stale_note": "Usually a Hive cloud blip. If it lasts, check the integration.",
        "sensor_unchanged_note": "Hive only sends a new value when it changes, so a steady house looks like this too. Worth a look at the integration if it stays frozen.",
    ...
    "pl": {
        ...
        "sensor_unavailable_header": "⚠️ Czujnik Hive nie podaje danych",
        "sensor_unchanged_header": "⚠️ Odczyt temperatury nie drgnął",
        "sensor_stale_unavailable": "Czujnik zgłasza „unavailable”.",
        "sensor_stale_age": "Bez zmiany od {age}, nadal {temperature} °C.",
        "sensor_stale_note": "Zwykle to blip chmury Hive. Jeśli utrzyma się dłużej, sprawdź integrację.",
        "sensor_unchanged_note": "Hive przysyła nową wartość tylko wtedy, gdy się zmieni, więc spokojny dom wygląda tak samo. Jeśli odczyt stoi dalej, warto zajrzeć w integrację.",
